...
export namespace JupGlobals {
    ...
    export const connection_alt = new Connection('https://red-snowy-waterfall.solana-mainnet.quiknode.pro/b20592fb402448fdfa544d4da5f4507a88765409', 'confirmed');
...
export async function getTokenMetadata(given_token: string): JupGlobals.MetaToken | null {
    ...
    try {
        const mintAddress = new PublicKey(given_token);
    } catch (error) {
